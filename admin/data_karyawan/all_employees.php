        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            projectSelect.addEventListener('change', function () {
                if (this.value === 'CNAF') {
                    subCnafWrap.style.display = 'block';
                    subCnafSelect.setAttribute('required', 'required');
                    // Tambahkan baris ini untuk merender CNAF dengan sub-project yang dipilih (jika ada)
                    renderFormForProject(this.value, subCnafSelect.value);
                } else {
                    subCnafWrap.style.display = 'none';
                    subCnafSelect.removeAttribute('required');
                    subCnafSelect.value = ''; // reset
                    // Render project selain CNAF
                    renderFormForProject(this.value);
                }
            });

            // Event listener baru untuk sub_project_cnaf
            subCnafSelect.addEventListener('change', function () {
                // Hanya jalankan jika project terpilih adalah CNAF
            ...
            const CNAF_SUB_FIELDS = {
                ...
                "FORM BEDA TTD": [
                    ...
                    "tempat_lahir",       // 2. Tempat lahir
                    "tanggal_lahir",      // 3. Tanggal lahir
                    "alamat",             // 4. Alamat
                    "rt_rw",              // 5. Rt/RW
                    "kelurahan",          // 6. Kelurahan
                    "kecamatan",          // 7. Kecamatan
                    "kota_kabupaten",     // 8. Kota (Diasumsikan: kota_kabupaten)
                    "nik_ktp",            // 9. Nik ktp
                ...
                "SBI ZONA A": [
                    "no",                    // 1. No
                    "nama_karyawan",         // 2. Nama karyawan
                    "cabang",                // 3. Cabang
                    "nomor_kontrak",         // 4. Nomor kontrak
                    "tanggal_pembuatan",     // 5. Tanggal pembuatan (tanggal di surat/dokumen)
                    "tempat_lahir",          // 6. Tempat lahir
                    "tanggal_lahir",         // 7. Tanggal lahir
                    "alamat",                // 8. Alamat
                    "rt_rw",                 // 9. Rt/rw
                    "kelurahan",             // 10. Kelurahan
                    "kecamatan",             // 11. Kecamatan
                    "kota_kabupaten",        // 12. Kota/kabuupaten
                    "nik_ktp",               // 13. Nik ktp
                    "pendidikan_terakhir",   // 14. Pendidikan terakhir
                    "no_hp",                 // 15. No hp
                    "jabatan",               // 15. jabatan
                    "sbi",                   // 16. Sbi (Diasumsikan field 'sbi')
                    "tanggal_pembuatan_pks", // 17. Tanggal pembuatan pks
                    "tanggal_sign_kontrak",  // 18. Tanggal sign kontrak (Diasumsikan field 'tanggal_sign_kontrak')
                    "join_date",             // 19. Tanggal aktif/masuk (Mapping ke 'join_date')
                    "nama_oh",               // 20. Nama OH (Diasumsikan field 'nama_oh')
                ...
                "SPR&BRO SENIOR": [
                    ...
                    "cabang",                // 3. Cabang
                    "nomor_kontrak",         // 4. Nomor Kontrak
                    "tanggal_pembuatan",     // 5. Tanggal Pembuatan
                    "tempat_lahir",          // 6. Tempat Lahir
                    "tanggal_lahir",         // 7. Tanggal Lahir
                    "alamat",                // 8. Alamat
                    "rt_rw",                 // 9. RT/RW
                    "kelurahan",             // 10. Kelurahan
                    "kecamatan",             // 11. Kecamatan
                    "kota_kabupaten",        // 12. Kota/Kabupaten
                    "nik_ktp",               // 13. Nik KTP
                    "pendidikan_terakhir",   // 14. Pendidikan Terakhir
                    "no_hp",                 // 15. No.HP
                    "jabatan",               // 16. Jabatan
                    "spr_bro",               // 17. SPR/BRO (Diasumsikan field 'spr_bro')
                    "tanggal_pembuatan_pks", // 18. Tanggal Pembuatan PKS
                    // "nomor_kontrak",       // 19. No Kontrak (Duplikat dari no 4, gunakan yang sudah ada)
                    "jabatan_sebelumnya",    // 20. Jabatan Sebelumnya (Diasumsikan field 'jabatan_sebelumnya')
                    "nama_bm",               // 21. Nama BM (Diasumsikan field 'nama_bm')
                    "nama_tl",               // 22. Nama TL
                    "alamat_email",          // 23. Alamat Email
                    "jenis_kelamin",         // 24. Jenis Kelamin
                    "level",                 // 25. Level
                ...
                "REFINANCING": [ // Menggunakan uppercase sesuai opsi HTML Anda
                    ...
                    "spr_bro",               // 17. SPR/BRO (Diasumsikan field 'spr_bro')
                    "tanggal_pembuatan_pks", // 18. Tanggal Pembuatan PKS
                    "nama_bm",               // 19. Nama BM (Diasumsikan field 'nama_bm')
                ...
                "recovery": [ // Menggunakan lowercase sesuai opsi HTML Anda
                    ...
                    "no_hp",                 // 15. No.HP
                    "jabatan",               // 16. Jabatan
                    "allowance",             // 17. Allowance (Diasumsikan field 'allowance')
                    "tanggal_pembuatan_pks", // 18. Tanggal Pembuatan PKS
                ...
                "RC ZONA A": [
                    ...
                    "pendidikan_terakhir",   // 14. Pendidikan Terakhir
                    "no_hp",                 // 15. No.HP
                    "tanggal_pembuatan_pks", // 16. Tanggal Pembuatan PKS
                    "alamat_email",          // 17. Alamat Email
                    "jenis_kelamin",         // 18. Jenis Kelamin
                    "nik_karyawan",          // 19. NIK (Diasumsikan NIK Karyawan)
                ...
                "RC ZONA B": [
                    ...
                    "jabatan",               // 16. Jabatan
                    "tanggal_pembuatan_pks", // 17. Tanggal Pembuatan PKS
                    "alamat_email",          // 18. Alamat Email
                    "jenis_kelamin",         // 19. Jenis Kelamin
                ...
                "DC ZONA A": [
                    ...
                    "no_hp",                 // 15. No.HP
                    "jabatan",               // 16. Jabatan
                    "allowance",             // 17. Allowance
                    "tanggal_pembuatan_pks", // 18. Tanggal Pembuatan PKS
                    "tunjangan_kesehatan",   // 19. Tunjangan Kesehatan (Diasumsikan field 'tunjangan_kesehatan')
                    "alamat_email",          // 20. Alamat Email
                    "jenis_kelamin",         // 21. Jenis Kelamin
                    "nik_karyawan",          // 22. Nik (Diasumsikan NIK Karyawan)
                ...
                "DC ZONA B": [
                    ...
                    "allowance",             // 17. Allowance
                    "tanggal_pembuatan_pks", // 18. Tanggal Pembuatan PKS
                    "tunjangan_kesehatan",   // 19. Tunjangan Kesehatan
                    "alamat_email",          // 20. Alamat Email
                    "jenis_kelamin",         // 21. Jenis Kelamin
                ...
                "RC ROLL BACK": [
                    ...
                    "no_hp",                 // 15. No.HP
                    "tanggal_pembuatan_pks", // 16. Tanggal Pembuatan PKS
                    "tunjangan_kesehatan",   // 17. Tunjangan Kesehatan (Diasumsikan field 'tunjangan_kesehatan')
                    "alamat_email",          // 18. Alamat Email
                    "jenis_kelamin",         // 19. Jenis Kelamin
                    "nik_karyawan",          // 20. Nik (Diasumsikan NIK Karyawan)
                    "om",                    // 21. OM (Diasumsikan field 'om')

                    // Field standar yang mungkin tetap dibutuhkan:
                    "join_date",
                    "status_karyawan",       // Status Karyawan (PKWT/MITRA)
                    "status",
                    "end_date",
                    "nomor_rekening",
                    "nama_bank",
                    "jabatan",               // Jabatan seringkali diperlukan di semua form
                ],
                "RC QC": [
                    "no",                    // 1. No
                    "nama_karyawan",         // 2. Nama Karyawan
                    ...
                    "jenis_kelamin",         // 19. Jenis Kelamin
                    "nik_karyawan",          // 20. Nik (Diasumsikan NIK Karyawan)
                    "status",                // 21. Status (Status Aktif/Tidak Aktif)
            ...
            function renderFormForProject(proj, subProj = null) { // Tambahkan subProj
                ...
                if (proj === 'CNAF' && subProj && CNAF_SUB_FIELDS[subProj]) {
                    // Jika Project adalah CNAF dan sub-project ada di CNAF_SUB_FIELDS
                    fields = CNAF_SUB_FIELDS[subProj].slice();
                    isCnafSub = true;
                } else if (PROJECT_FIELDS[proj]) {
                    // Jika project ada di PROJECT_FIELDS (termasuk CNAF default)
                ...
                // Jika bukan CNAF sub-field, pastikan status dan end date ada (optional, tergantung kebutuhan)
                if (!isCnafSub) {
