    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <?php if (isset($_GET['deleted']) && $_GET['deleted'] == 1): ?>
                <div
                    style="padding:12px;background:#fdecea;color:#611a15;border:1px solid #f5c6cb;border-radius:5px;margin-bottom:15px;">
                            ...
                            foreach ($invoices as $invoice): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span
                                            class="status-label <?= e($status_class) ?>"><?= e($invoice['status_pembayaran']) ?></span>
                                    </td>
                                    <td class="action-buttons" style="display:flex; gap:6px; align-items:center;">
                                        <?php if (strtoupper(trim($invoice['project_code'] ?? '')) === 'PEI'): ?>
                                            <a class="action-btn view-btn"
                                                href="view_invoice_pei.php?id=<?= (int) $invoice['id_invoice'] ?>" title="Lihat">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                        <?php else: ?>
                                            <a class="action-btn view-btn"
                                                href="view_invoice.php?id=<?= (int) $invoice['id_invoice'] ?>" title="Lihat">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                        <?php endif; ?>
                                        ...
                                        <form action="delete_invoice.php" method="POST"
                                            onsubmit="return confirm('Hapus invoice ini? Tindakan tidak bisa dibatalkan.');"
                            ...
                            <div style="display: flex; justify-content: flex-end; width: 100%;">
                                <div style="width: 45%; text-align: left; margin-top: 30px;">
                                    <p style="margin: 0 0 10px 0;">
                                        Jakarta, <input type="date" name="footer_date" value="<?= date('Y-m-d'); ?>"
                                            required
