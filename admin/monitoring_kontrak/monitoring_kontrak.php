...
if ($r_proyek)
    $all_proyek = array_column($r_proyek->fetch_all(MYSQLI_ASSOC), 'proyek');
        ...
        <div class="card">
            ...
            <div class="foot" style="justify-content:flex-end; display:flex; gap:8px;">
                ...
                <form id="formGenerate" method="post" action="surat_tugas_download.php" target="_blank">
                    ...
                    <button class="btn primary" type="submit" onclick="closeSurat()"><i class="fa fa-download"></i>
                        Generate & Unduh</button>
                </form>
            </div>
        </div>
    </div>
