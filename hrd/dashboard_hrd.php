...
<head>
    ...
    <style>
        ...
        .card-title { font-size: 14px; color: #6c757d; margin: 0; }
        .card-value { font-size: 2rem; font-weight: 700; color: #333; margin: 5px 0 0; }
        .summary-absensi {
            background-color: #fff;
            padding: 25px;
            border-radius: 12px;
        ...
        .data-box h3 { font-size: 2rem; font-weight: 700; margin: 0 0 5px; }
        .data-box p { font-size: 0.9rem; color: #888; margin: 0; }
